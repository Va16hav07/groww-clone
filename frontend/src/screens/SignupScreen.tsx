...
import { View, Text, TextInput, TouchableOpacity, SafeAreaView, KeyboardAvoidingView, Platform, ScrollView, Image, ActivityIndicator } from 'react-native';
...
export default function SignupScreen({ onNavigateToLogin }: SignupScreenProps): React.ReactElement {
  ...
  return (
    <SafeAreaView className="flex-1 bg-white">
      ...
      <KeyboardAvoidingView 
        ...
        className="flex-1"
      >
        <ScrollView contentContainerStyle={{ flexGrow: 1 }} className="flex-1 px-6 pt-10 pb-8">
          
          {/* Back Button */}
          <TouchableOpacity onPress={onNavigateToLogin} className="w-10 h-10 justify-center mb-2 mt-4">
          ...
          <View className="items-center mt-auto pt-10 mb-4">
            ...
            <Text className="text-center text-gray-500 text-sm">
              By signing up, you accept our <Text className="text-emerald-600 font-medium">Terms</Text> and <Text className="text-emerald-600 font-medium">Privacy Policy</Text>.
            </Text>
          </View>
